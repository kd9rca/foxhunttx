...
#define rest 30000                //the amount of time between transmits in ms, default 30000 = 30seconds
...
#define patternCount 4            //number of times to repeat tone pattern at beginning of cycle, default 4
...
void setup() {                        //sets the pins to desired mode
  ...
  pinMode(13, OUTPUT);               //used to see how the cw looks with onboard led pin 13, comment entire line to disable
